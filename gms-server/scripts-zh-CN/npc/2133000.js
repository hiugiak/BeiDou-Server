        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                if (!cm.haveItem(1032060) && cm.haveItem(4001198, 1)) {
                    ...
                    cm.sendOk("你要么已经有了阿尔泰耳环，要么没有阿尔泰碎片。");
                    cm.dispose();
                }
            } else if (selection == 1) {
                if (cm.haveItem(1032060) && !cm.haveItem(1032061) && cm.haveItem(4001198, 1)) {
                    ...
                    cm.sendOk("你要么还没有阿尔泰耳环，要么没有阿尔泰碎片。");
                    cm.dispose();
                }
            } else if (selection == 2) {
                if (cm.haveItem(1032061) && !cm.haveItem(1032072) && cm.haveItem(4001198, 1)) {
                    ...
                    cm.sendOk("你要么还没有闪耀的阿尔泰尔耳环，要么没有阿尔泰尔碎片。");
                    cm.dispose();
                }
            }
        }
