...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        if (selectedType == 0) { 
            ...
            var materials = ["#k#v4030012#100个#t4030012#兑换#k#v2101049:#盖斯特巴洛召唤包", "#k#v4030012#10个#t4030012#兑换#k#v2100135:#5000万血木桩", "#k20个#v4000126#兑换#v2383026:##t2383026#", "#k20个#v4000124#兑换#v2383004:##t2383004#", "#k20个#v4000362#兑换#v2385023:##t2385023#",
        ...
        if (selectedType == 2) { 
            ...
            var itemSet = [2101049, 2100135, 2383026, 2383004, 2385023, 2384038, 2384040, 2384010, 2384037, 2384039, 2383048, 2383049, 2388069, 2388068, 2388067, 2388040, 2388041, 2388042];
            var matSet = [4030012, 4030012, 4000126, 4000124, 4000362, 4000411, 4000419, 4000336, 4000415, 4000416, 4000413, 4000412, 4000505, 4000506, 4000504, 4000460, 4000461, 4000462];
            var matQtySet = [100, 10, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20];
